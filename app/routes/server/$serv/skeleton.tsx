...
export async function loader({ params }: RouteContext<typeof parameters>) {
	...
	return shell(<div style="display: contents;">
		...
		<a href={`/server/${params.serv}/leaderboard`} style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "10px" }} >
			<div class="skeleton" style={{ height: "80px", borderRadius: "10px" }}></div>
			<div class="skeleton" style={{ height: "80px", borderRadius: "10px" }}></div>
			<div class="skeleton" style={{ height: "80px", borderRadius: "10px" }}></div>
			<div class="skeleton" style={{ height: "80px", borderRadius: "10px" }}></div>
		</a>
